...
#ifndef __VCS_IMPORT_DPI_STUB_tb_memory_read
#define __VCS_IMPORT_DPI_STUB_tb_memory_read
__attribute__((weak)) void tb_memory_read(/* INPUT */long long A_1, /* INPUT */int A_2, const /* OUTPUT */svOpenArrayHandle A_3)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static void (*_vcs_dpi_fp_)(/* INPUT */long long A_1, /* INPUT */int A_2, const /* OUTPUT */svOpenArrayHandle A_3) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (void (*)(long long A_1, int A_2, const svOpenArrayHandle A_3)) dlsym(RTLD_NEXT, "tb_memory_read");
    ...
    if (_vcs_dpi_fp_) {
        ...
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "tb_memory_read");
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_tb_memory_read */

#ifndef __VCS_IMPORT_DPI_STUB_tb_memory_write
#define __VCS_IMPORT_DPI_STUB_tb_memory_write
__attribute__((weak)) void tb_memory_write(/* INPUT */long long A_1, /* INPUT */int A_2, const /* INPUT */svOpenArrayHandle A_3, const /* INPUT */svOpenArrayHandle A_4)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static void (*_vcs_dpi_fp_)(/* INPUT */long long A_1, /* INPUT */int A_2, const /* INPUT */svOpenArrayHandle A_3, const /* INPUT */svOpenArrayHandle A_4) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (void (*)(long long A_1, int A_2, const svOpenArrayHandle A_3, const svOpenArrayHandle A_4)) dlsym(RTLD_NEXT, "tb_memory_write");
        _vcs_dpi_stub_initialized_ = 1;
    }
    if (_vcs_dpi_fp_) {
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "tb_memory_write");
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_tb_memory_write */
